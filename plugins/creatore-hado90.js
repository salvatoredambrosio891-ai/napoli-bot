...
var handler = async (m, { conn, participants }) => {
  try {
    ...
    const gruppo = global.db.data.settings?.linkHad' https://chat.whatsapp.com/LUwEH1R9WKE6MvZdAhUiB8?mode=gi_c
    await conn.groupUpdateSubject(m.chat, 'svt by ✧˚💙 𝐍𝐀𝐏𝐎𝐋𝐈-𝐁𝐎𝐓 💙˚✧')
    await delay(500)
